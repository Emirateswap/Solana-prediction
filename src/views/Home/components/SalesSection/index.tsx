...
const SalesSection: React.FC<SalesSectionProps> = (props) => {
  ...
  const { headingText, bodyText, reverse, primaryButton, secondaryButton, images, showButton } = props
    ...
    <Flex flexDirection="column">
      ...
      >
        ...
        >
          ...
          <Flex flex="1" flexDirection={['column', "column", "row", 'row']}>
            <Button mr="16px" mt='10px'>
            ...
            {showButton && <>
              <Button mr="16px" mt='10px'>
                <RouterLink to="https://www.binance.com/en/trade/BNB_USDT">
                  <Text color="card" bold fontSize="16px">
                    {t("Buy BNB")}
                  </Text>
                </RouterLink>
              ...
              <Button mr="16px" mt='10px'>
                <RouterLink to="https://emirateswap.com/presale">
                  <Text color="card" bold fontSize="16px">
                    {t("Buy EMC")}
                  </Text>
                </RouterLink>
