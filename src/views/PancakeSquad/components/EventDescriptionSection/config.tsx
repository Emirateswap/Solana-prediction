...
const eventDescriptionConfigBuilder = ({ t }: EventDescriptionType) => ({
  ...
  image: { src: '/solana/images/pancakeSquad/moonBunny/body.png', alt: 'moon bunny' },
  accessoriesImages: [
    { src: '/solana/images/pancakeSquad/moonBunny/band.png', alt: 'headband' },
    { src: '/solana/images/pancakeSquad/moonBunny/cloth.png', alt: 'cloth' },
    { src: '/solana/images/pancakeSquad/moonBunny/glasses.png', alt: 'glasses' },
    { src: '/solana/images/pancakeSquad/moonBunny/pancake.png', alt: 'pancake' },
  ],
})
