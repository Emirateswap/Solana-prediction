...
export const fetchPoolsPublicDataAsync = () => async (dispatch, getState) => {
  try {
    ...
    const liveData = poolsConfig.map((pool) => {
      ...
      const earningTokenPrice = earningTokenAddress ? prices[earningTokenAddress] ? prices[earningTokenAddress] : 0 : 0
      const apr = !isPoolFinished
        ...
        : 0
        // console.log('----apr', earningTokenAddress,earningTokenPrice,stakingTokenPrice,totalStaking,parseFloat(pool.tokenPerBlock))
