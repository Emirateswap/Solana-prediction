...
const deserializeFarm = (farm: SerializedFarm): DeserializedFarm => {
  // console.log('deserializedFarm---', farm)
 ...
 * 251 = CAKE-BNB LP      3 = CAKE-BNB LP   5 = CAKE-BUSD LP
 * 252 = BUSD-BNB LP      8 = BUSD-BNB LP
 */
export const usePollCoreFarmData = () => {
  ...
  useEffect(() => {
    dispatch(fetchFarmsPublicDataAsync([3, 8]))
...
export const usePriceCakeBusd = (): BigNumber => {
  const cakeBusdFarm = useFarmFromPid(5)
...
//   const busdBnbFarm = useFarmFromPid(8)
//   // const cakeBnbFarm = useFarmFromPid(251)

//   const bnbPriceBusdAsString = busdBnbFarm.quoteTokenPriceBusd
...
export const usePriceBNBBusd = (): BigNumber => {
  ...
  const bnbPriceBusd = JSON.parse(httpGet(url)).price
